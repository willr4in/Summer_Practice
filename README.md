...
Из графиков наглядно видно, хоть и не с большим перевесом, но с генерацией картинок с использованием заданной позы справляется лучше Stable Diffusion с ControlNet средний показатель FID у него равен 15,4 в отличие от 23 у Kandinskiy.
## 5. Обсуждение
